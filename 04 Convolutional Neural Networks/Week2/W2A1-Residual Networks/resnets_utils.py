...
def load_dataset():
    train_dataset = h5py.File('/content/drive/MyDrive/Coursera_DL/04 Convolutional Neural Networks/Week2/W2A1-Residual Networks/datasets/train_signs.h5', "r")
    ...
    test_dataset = h5py.File('/content/drive/MyDrive/Coursera_DL/04 Convolutional Neural Networks/Week2/W2A1-Residual Networks/datasets/test_signs.h5', "r")
